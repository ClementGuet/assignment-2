...
public class Client {
    ...
    private void getTemperature() {
    	while(true) {
    	ReadTemp();
    	Temperature temperature = new Temperature(valueTemp,Calendar.getInstance(),0,"Name");
    	System.out.println("01. -> Sending Command (" + temperature + ") to the server...");
    	this.send(temperature);
    	try{
    		temperature = (Temperature) receive();
    	...
    	try
    	{
    	    Thread.sleep(temperature.gettime());
    	}
